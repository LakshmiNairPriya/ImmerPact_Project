...
<th>Action</th>
  ...
  <td>{{$item->email}}</td>
  <td>
      <a href="{{url('/delete/'.$item->id)}}" class="btn btn-danger"><span class="bi bi-trash"size="10px"></span></i></a>
    </td>
  <td><a href="{{url('editcustomer/'.$item->id)}}" class="btn btn-secondary"><i class="bi bi-pencil"size="10px"></i></a></td>
 </tr>
 @endforeach
  </tbody>
