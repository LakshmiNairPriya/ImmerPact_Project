...
<button type="button" class="btn btn-success" id ="btnback"onclick="window.location.href='{{url('/customerlist')}}'">Go Back</button><hr>
</div> 
...
<button type="submit" class="btn btn-success" id ="btnform">Update</button>
